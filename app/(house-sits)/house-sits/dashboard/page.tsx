...
import type { BookingRead, BookingStatus, FavoriteHouseSitter } from '@/types'
              ...
              <div className="ml-auto w-full max-w-md rounded-3xl border border-white/25 bg-black/35 p-5 backdrop-blur-sm sm:p-6">
                ...
                <div className="mt-4">
                  ...
                  {!nextBooking ? (
                    ...
                    <Link
                      href={`/house-sits/bookings/${nextBooking.id}`}
        ...
        <section className="grid gap-6 lg:grid-cols-[1.5fr_0.95fr]">
          <div className="rounded-[1.5rem] border border-slate-200/80 bg-white/90 p-4 shadow-[0_18px_45px_rgba(11,33,78,0.08)] backdrop-blur-sm sm:p-6">
            <div className="mb-4 flex flex-col items-start gap-2 sm:flex-row sm:items-end sm:justify-between sm:gap-4">
              ...
              <Link href="/house-sits/bookings" className="text-sm font-semibold text-[#5a4a3b] hover:underline">
                View all
              </Link>
            </div>
            ...
            {recent.length === 0 ? (
              ...
              <div className="space-y-2">
                {recent.map((booking, index) => {
                  ...
                  <Link
                    key={booking.id}
                    href={`/house-sits/bookings/${booking.id}`}
          ...
          <div className="space-y-4">
            <div className="rounded-[1.25rem] border border-slate-200/80 bg-white/90 p-4 shadow-[0_16px_36px_rgba(11,33,78,0.08)] backdrop-blur-sm sm:p-5">
              ...
              <div className="mt-4 space-y-2">
                <ActionLink href="/house-sits/house-sitters" icon={<Search className="h-4 w-4" />} label="Browse sitters" />
                <ActionLink href="/house-sits/bookings" icon={<Sparkles className="h-4 w-4" />} label="Manage bookings" />
                <ActionLink href="/house-sits/report" icon={<CircleAlert className="h-4 w-4" />} label="Report a problem" />
              </div>
            </div>
