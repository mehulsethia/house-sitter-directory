  ...
  return (
    <>
      <div className="houseSit-bookings-revamp space-y-7 md:space-y-9">
        ...
        <section className="rounded-[1.5rem] border border-slate-200/80 bg-white/90 p-4 shadow-[0_16px_38px_rgba(74,56,39,0.12)] backdrop-blur-sm sm:p-6">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="mt-4 flex flex-wrap items-center gap-2">
                        ...
                        {canChat && (
                          <Link
                            href={`/house-sits/chats?booking=${booking.id}`}
                            className="inline-flex h-8 items-center rounded-full border border-slate-300 px-3 text-xs font-semibold text-slate-700 transition hover:bg-slate-50"
                          >
                            Message
                          </Link>
                        ...
                        {canDispute && (
                          <Link
                            href={`/house-sits/report?booking=${booking.id}`}
                            className="inline-flex h-8 items-center rounded-full bg-[#5a4a3b] px-3 text-xs font-semibold text-white transition hover:bg-[#4b3d31]"
                          >
                            Report a problem
                          </Link>
...
function MetricChip({
  ...
  return (
    ...
    >
      <div className="mb-1 inline-flex h-7 w-7 items-center justify-center rounded-full bg-white/15 text-amber-100">
        {icon}
      </div>
