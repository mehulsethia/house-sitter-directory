...
export default function AdminCleanersPage() {
  ...
  const [rejectTarget, setRejectTarget] = useState<AdminHouseSitter | null>(null)
  ...
  async function submitReject() {
    ...
    setRejecting(true)
    try {
      await adminApi.approveHouseSitter(rejectTarget.id, 'reject', customMessage || getCleanerRejectionReasonLabel(rejectReasonCode as any), {
