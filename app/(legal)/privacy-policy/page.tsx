...
export const metadata: Metadata = {
  ...
  description: 'Learn how The House Sitter Directory collects, uses, and protects your personal data.',
}
      ...
      <div className="bg-white px-6 py-16">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mb-12 text-gray-600 leading-relaxed space-y-4 text-[15px]">
            <p>
              This Privacy Policy explains how The House Sitter Directory collects, uses, stores, and protects personal data in connection with your use of the House Sitter Directory platform, including our website, applications, and related services.
            </p>
            <p>
              The House Sitter Directory is committed to protecting user privacy and processing personal data in accordance with applicable data protection laws, including the General Data Protection Regulation (GDPR).
            </p>
          </div>

          {/* ─── Section 1 ─── */}
          <Section number="1" title="Information We Collect">
            <p>The House Sitter Directory collects and processes certain personal data in order to operate the Platform, facilitate bookings between Homeowners and House Sitters, process payments, maintain platform safety, and comply with legal obligations.</p>
            ...
            <SubSection number="1.1" title="Account Information">
              <p>When users create an account on the Platform, The House Sitter Directory collects information necessary to establish and manage the account.</p>
              ...
              <BulletList items={[
                ...
                'account role (Homeowner or House Sitter).',
              ]} />
            ...
            <SubSection number="1.2" title="Profile and Service Information">
              ...
              <p>For House Sitters, this may include:</p>
              <BulletList items={[
              ...
              <p>For Homeowners, this may include:</p>
              <BulletList items={[
                'service preferences',
                'saved addresses for service locations',
                'notes or instructions relating to bookings.',
              ]} />
              <p>Certain profile information provided by House Sitters may be visible to Homeowners when browsing available service providers.</p>
            </SubSection>

            <SubSection number="1.3" title="Booking and Transaction Information">
              <p>When a booking is created or managed through the Platform, The House Sitter Directory collects information required to facilitate the service and manage the transaction.</p>
              <p>This may include:</p>
              <BulletList items={[
            ...
            <SubSection number="1.4" title="Identity Verification Information (House Sitters)">
              <p>House Sitters may be required to provide identity verification documentation as part of the platform onboarding or approval process.</p>
              <p>This may include:</p>
              <BulletList items={[
              ...
              <p>These documents are stored securely within The House Sitter Directory\u2019s infrastructure and are accessible only to authorised administrators for the purpose of verifying identity and maintaining platform safety.</p>
            </SubSection>

            <SubSection number="1.5" title="Communications and Messaging">
              <p>The Platform may allow Homeowners and House Sitters to communicate through in-platform messaging features in connection with confirmed bookings.</p>
              <p>The House Sitter Directory may collect and store:</p>
              <BulletList items={[
                'messages exchanged between users through the Platform',
                'support communications sent to The House Sitter Directory',
            ...
            <SubSection number="1.6" title="Dispute Reports and Evidence">
              <p>If a user submits a dispute or reports a problem relating to a booking, The House Sitter Directory may collect additional information necessary to review the issue.</p>
              <p>This may include:</p>
              <BulletList items={[
            ...
            <SubSection number="1.7" title="Location Verification Data">
              <p>When a House Sitter confirms arrival at a booking using the Platform, the system may record:</p>
              <BulletList items={[
            ...
            <SubSection number="1.8" title="Device and Usage Information">
              ...
              <p>This information helps The House Sitter Directory maintain platform functionality, detect abuse, and improve platform performance.</p>
            </SubSection>
          ...
          <Section number="2" title="Legal Basis for Processing (GDPR Article 6)">
            <p>Under the General Data Protection Regulation (GDPR), The House Sitter Directory processes personal data only where a valid legal basis exists. The legal bases relied upon by The House Sitter Directory depend on the nature of the data being processed and the context in which it is collected.</p>
            <p>The House Sitter Directory primarily relies on the following legal bases: contract performance, legitimate interests, legal obligations, and user consent.</p>

            <SubSection number="2.1" title="Performance of a Contract">
              <p>The House Sitter Directory processes personal data where necessary to provide the services requested by users and to operate the Platform.</p>
              <p>This includes processing necessary to:</p>
              <BulletList items={[
                'create and manage user accounts',
                'facilitate bookings between Homeowners and House Sitters',
                'process service scheduling and booking confirmations',
                'enable communication between Homeowners and House Sitters for confirmed bookings',
                'process payments, refunds, and payouts through payment processors',
                'maintain booking records and service history.',
              ]} />
              <p>Without processing this information, The House Sitter Directory would not be able to operate the marketplace services requested by users.</p>
            </SubSection>

            <SubSection number="2.2" title="Legitimate Interests">
              <p>The House Sitter Directory may process personal data where necessary for the legitimate interests of operating, protecting, and improving the Platform, provided such interests are not overridden by users\u2019 data protection rights.</p>
              <p>These legitimate interests include:</p>
              <BulletList items={[
                'maintaining platform safety and trust between users',
                'verifying the identity of House Sitters during onboarding',
              ...
              <p>Where possible, The House Sitter Directory takes steps to minimise the amount of personal data processed for these purposes.</p>
              <p>The House Sitter Directory processes only the minimum amount of personal data necessary to achieve the purposes described in this Privacy Policy.</p>
            </SubSection>

            <SubSection number="2.3" title="Compliance with Legal Obligations">
              <p>Certain personal data may be processed where necessary for The House Sitter Directory to comply with applicable legal or regulatory obligations.</p>
            ...
            <SubSection number="2.4" title="User Consent">
              <p>In certain circumstances, The House Sitter Directory relies on user consent to process personal data.</p>
              <p>This includes:</p>
              <BulletList items={[
          ...
          <Section number="3" title="How We Use Your Information">
            <p>The House Sitter Directory uses personal data to operate, maintain, and improve the Platform and to facilitate the services provided between Homeowners and House Sitters.</p>
            ...
            <SubSection number="3.1" title="Providing and Operating the Platform">
              <p>The House Sitter Directory processes personal data to operate the marketplace services and allow users to access and use the Platform.</p>
              <p>This includes processing necessary to:</p>
              <BulletList items={[
                'create and manage user accounts',
                'enable users to log in and manage their profiles',
                'display House Sitter profiles to Homeowners',
                'allow Homeowners to browse and select House Sitters',
                'enable booking requests and service scheduling',
                'store booking details and service history.',
              ]} />
              <p>Without this processing, The House Sitter Directory would not be able to provide the platform services requested by users.</p>
            </SubSection>

            <SubSection number="3.2" title="Facilitating Bookings Between Homeowners and House Sitters">
              <p>Personal data is used to enable and manage service bookings between Homeowners and House Sitters.</p>
              <p>This includes processing necessary to:</p>
              <BulletList items={[
                'create booking requests and booking confirmations',
                'record booking details such as service duration, time, and location',
                'share limited information between Homeowners and House Sitters for confirmed bookings',
                'allow communication between users in connection with bookings',
                'coordinate service delivery.',
              ]} />
              <p>Homeowners choose a House Sitter and submit a booking request through the Platform. The House Sitter Directory does not automatically assign service providers.</p>
            </SubSection>

            <SubSection number="3.3" title="Payment Processing and Financial Administration">
              <p>The House Sitter Directory processes certain personal and transactional data to facilitate payments and manage financial records associated with bookings.</p>
              <p>This includes processing necessary to:</p>
              <BulletList items={[
                ...
                'manage payouts to House Sitters through third-party payment processors.',
              ]} />
              <p>Payment processing is performed through secure third-party payment providers such as Stripe. The House Sitter Directory does not store full payment card numbers.</p>
            </SubSection>

            <SubSection number="3.4" title="Platform Safety, Trust, and Verification">
              <p>The House Sitter Directory processes personal data to maintain trust and safety on the Platform.</p>
              <p>This includes processing necessary to:</p>
              <BulletList items={[
                'verify House Sitter identity documentation during onboarding',
            ...
            <SubSection number="3.5" title="Dispute Investigation and Resolution">
              <p>Where a dispute or issue is reported relating to a booking, The House Sitter Directory may process relevant personal data in order to review and resolve the matter.</p>
              <p>This may include:</p>
              <BulletList items={[
            ...
            <SubSection number="3.6" title="Performance Metrics and Platform Reputation Systems">
              <p>The House Sitter Directory may use certain booking and performance data to maintain reputation systems and performance indicators on the Platform.</p>
              <p>This may include:</p>
              <BulletList items={[
              ...
              <p>These metrics help Homeowners make informed booking decisions and help maintain service quality on the Platform.</p>
            </SubSection>

            <SubSection number="3.7" title="Customer Support and Account Assistance">
              <p>Personal data may be used by The House Sitter Directory support personnel to assist users with platform-related issues.</p>
              <p>This may include:</p>
              <BulletList items={[
            ...
            <SubSection number="3.8" title="Platform Improvements and Analytics">
              <p>The House Sitter Directory may analyse aggregated or anonymised usage information in order to improve the Platform.</p>
              <p>This may include:</p>
              <BulletList items={[
              ...
              <p>Where possible, The House Sitter Directory uses aggregated or anonymised data for these purposes.</p>
            </SubSection>

            <SubSection number="3.9" title="Communications and Notifications">
              <p>The House Sitter Directory may send communications to users relating to their use of the Platform.</p>
              <p>These communications may include:</p>
              <BulletList items={[
          ...
          <Section number="4" title="How We Share Information">
            <p>The House Sitter Directory does not sell or rent users\u2019 personal data to third parties. Personal information may only be shared in limited circumstances necessary to operate the Platform and provide the services requested by users.</p>

            <SubSection number="4.1" title="Sharing Between Homeowners and House Sitters">
              <p>When a booking is created and accepted through the Platform, certain information must be shared between the Homeowner and the House Sitter in order to coordinate the service.</p>
              <p>For confirmed bookings, the House Sitter may receive limited information about the Homeowner, including:</p>
              <BulletList items={[
                'the Homeowner\u2019s first name or display name',
                'booking details such as date, time, and service duration',
                'the service location address',
                'booking notes or instructions provided by the Homeowner',
                'the ability to communicate with the Homeowner through the Platform.',
              ]} />
              <p>Prior to booking acceptance, House Sitters may see only limited booking information necessary to evaluate the request, such as the booking date, service duration, general notes, and an approximate location of the sitting location. The exact address and apartment or unit details are only provided after a booking has been accepted.</p>
              <p>Homeowners may also view information about House Sitters in order to select a service provider. This may include:</p>
              <BulletList items={[
                'cleaner name',
                'profile photo',
                'service description',
            ...
            <SubSection number="4.2" title="Contact Information for Booking Coordination">
              <p>Where necessary to coordinate a confirmed booking, certain contact information may be made available between the Homeowner and the House Sitter.</p>
              ...
              <p>The House Sitter Directory does not permit the use of contact information for purposes outside the Platform, including attempting to bypass platform payments or services.</p>
            </SubSection>

            <SubSection number="4.3" title="Service Providers and Platform Infrastructure">
              <p>The House Sitter Directory may share personal data with trusted third-party service providers that assist in operating the Platform.</p>
              ...
              <p>These service providers process data only on behalf of The House Sitter Directory and are required to implement appropriate data protection safeguards.</p>
            </SubSection>

            <SubSection number="4.4" title="Legal Requirements and Protection of Rights">
              <p>The House Sitter Directory may disclose personal data where required to do so by law or where disclosure is reasonably necessary to:</p>
              <BulletList items={[
                'comply with legal obligations',
                'respond to lawful requests from regulators, courts, or law enforcement authorities',
                'enforce The House Sitter Directory\u2019s Terms and platform policies',
                'protect the rights, property, or safety of The House Sitter Directory, its users, or the public.',
              ]} />
            </SubSection>

            <SubSection number="4.5" title="Business Transfers">
              <p>If The House Sitter Directory undergoes a business transaction such as a merger, acquisition, restructuring, or sale of assets, personal data held by the Platform may be transferred as part of that transaction.</p>
              <p>In such cases, The House Sitter Directory will take reasonable steps to ensure that personal data continues to be handled in accordance with this Privacy Policy.</p>
            </SubSection>

            <SubSection number="4.6" title="Internal Access and Administration">
              <p>Access to personal data within The House Sitter Directory is limited to authorised personnel who require such access in order to operate the Platform, provide customer support, review disputes, or enforce platform policies.</p>
              <p>The House Sitter Directory implements internal safeguards to ensure that personal data is accessed only where necessary and in accordance with applicable data protection laws.</p>
            </SubSection>
          </Section>

          {/* ─── Section 5 ─── */}
          <Section number="5" title="Cookies and Tracking Technologies">
            <p>The House Sitter Directory uses cookies and similar technologies to operate the Platform, maintain security, and improve user experience.</p>
            ...
            <SubSection number="5.1" title="Types of Cookies Used">
              ...
              <p>Analytics cookies help The House Sitter Directory understand how users interact with the Platform so that performance and user experience can be improved.</p>
          ...
          <Section number="6" title="Data Retention">
            <p>The House Sitter Directory retains personal data only for as long as necessary to provide the Platform, comply with legal obligations, resolve disputes, prevent fraud, and enforce its agreements.</p>
            ...
            <SubSection number="6.1" title="Account Information">
              ...
              <p>If a user deletes their account, The House Sitter Directory will remove or anonymise the account profile within a reasonable period, except where certain data must be retained for legal compliance, dispute resolution, fraud prevention, or enforcement of platform policies.</p>
            ...
            <SubSection number="6.4" title="Identity Verification Information (House Sitters)">
              <p>Identity verification documents submitted by House Sitters, such as government-issued identification, are stored securely and used solely for identity verification and compliance purposes.</p>
              <p>These documents are retained while the House Sitter account remains active and may be retained for a limited period following account deletion where necessary for fraud prevention or legal compliance.</p>
            ...
            <SubSection number="6.5" title="Messages and Communication Data">
              <p>Messages exchanged between Homeowners and House Sitters through the Platform may be retained for a limited period in order to:</p>
              <BulletList items={[
            ...
            <SubSection number="6.6" title="Analytics and Technical Data">
              ...
              <p>Where possible, The House Sitter Directory may anonymise or aggregate older usage data so that it no longer identifies individual users while still allowing the Platform to analyse performance trends and improve the Service.</p>
            </SubSection>
          </Section>

          {/* ─── Section 7 ─── */}
          <Section number="7" title="Data Security">
            <p>The House Sitter Directory implements appropriate technical and organisational measures designed to protect personal data against unauthorised access, alteration, disclosure, or destruction.</p>
            ...
            <SubSection number="7.1" title="Secure Platform Infrastructure">
              ...
              <p>This includes the use of encrypted connections (HTTPS / SSL / TLS) to secure communications between users\u2019 devices and The House Sitter Directory\u2019s servers.</p>
            </SubSection>
            ...
            <SubSection number="7.4" title="Secure Storage of Sensitive Documents">
              <p>Sensitive documents submitted through the Platform, including identity verification documents provided by House Sitters, are stored using secure storage systems designed to prevent unauthorised access.</p>
            ...
            <SubSection number="7.5" title="Security Monitoring">
              <p>The House Sitter Directory may monitor the Platform for suspicious activity, security vulnerabilities, or misuse in order to protect the integrity of the Service and the safety of its users.</p>
            </SubSection>

            <SubSection number="7.6" title="Security Incident Response">
              <p>While The House Sitter Directory implements reasonable security safeguards, no system can guarantee absolute security.</p>
              <p>If a security incident or data breach occurs that is likely to result in a risk to users\u2019 rights or freedoms, The House Sitter Directory may investigate the incident and take appropriate action, including notifying affected users and relevant regulatory authorities where required by applicable law.</p>
            </SubSection>
          </Section>

          {/* ─── Section 8 ─── */}
          <Section number="8" title="Your Rights">
            <p>Under applicable data protection laws, including the General Data Protection Regulation (GDPR), users have certain rights regarding their personal data processed by The House Sitter Directory.</p>
            <p>These rights may include the following.</p>

            <SubSection number="8.1" title="Right of Access">
              <p>Users may request confirmation as to whether The House Sitter Directory processes their personal data and may request access to a copy of such information.</p>
              <p>Most personal information associated with an account may be viewed directly within the Platform\u2019s user dashboard. Additional information may be requested by contacting The House Sitter Directory using the contact details provided in this Privacy Policy.</p>
            </SubSection>
            ...
            <SubSection number="8.3" title="Right to Erasure (Right to be Forgotten)">
              ...
              <p>Upon deletion, the user account will be deactivated and the public profile removed. Certain information may be retained where necessary to comply with legal obligations, resolve disputes, prevent fraud, or enforce The House Sitter Directory\u2019s Terms and platform policies.</p>
            </SubSection>

            <SubSection number="8.4" title="Right to Restrict Processing">
              <p>In certain circumstances, users may request that The House Sitter Directory restrict the processing of their personal data.</p>
            ...
            <SubSection number="8.5" title="Right to Data Portability">
              ...
              <p>Such requests may be submitted through The House Sitter Directory\u2019s support channels. The House Sitter Directory may provide the requested information within a reasonable timeframe in accordance with applicable data protection laws.</p>
            </SubSection>
            ...
            <SubSection number="8.7" title="Right to Lodge a Complaint">
              ...
              <p>Users may also contact The House Sitter Directory directly to seek resolution of any concerns regarding the handling of personal data.</p>
            </SubSection>

            <SubSection number="8.8" title="Automated Decision-Making">
              <p>The House Sitter Directory does not carry out automated decision-making or profiling that produces legal or similarly significant effects on users.</p>
            </SubSection>
          </Section>

          {/* ─── Section 9 ─── */}
          <Section number="9" title="Children\u2019s Privacy">
            <p>The House Sitter Directory Platform is intended for use by individuals who are at least 18 years of age.</p>
            <p>Users must be at least 18 years old to create an account, request services, or offer services through the Platform.</p>
            <p>The House Sitter Directory does not knowingly collect or process personal data from individuals under the age of 18.</p>
            <p>If The House Sitter Directory becomes aware that personal data has been collected from a person under the age of 18 without appropriate legal authority, The House Sitter Directory may take steps to remove the account and delete the associated data.</p>
            <p>Parents or guardians who believe that a minor has provided personal data to The House Sitter Directory may contact the Platform using the contact information provided in this Privacy Policy.</p>
          </Section>

          {/* ─── Section 10 ─── */}
          <Section number="10" title="Third-Party Services">
            <p>The House Sitter Directory may use third-party service providers to support the operation of the Platform. These providers perform services on behalf of The House Sitter Directory and may process personal data where necessary to provide those services.</p>
            ...
            <p>The categories of third-party services used by The House Sitter Directory may include the following.</p>

            <SubSection number="10.1" title="Payment Processing">
              <p>The House Sitter Directory uses third-party payment processors, including Stripe, to facilitate payments made through the Platform.</p>
            ...
            <SubSection number="10.2" title="Cloud Hosting and Infrastructure">
              <p>The House Sitter Directory uses third-party cloud infrastructure providers to host the Platform and its associated systems.</p>
            ...
            <SubSection number="10.3" title="Secure File Storage">
              <p>Files uploaded to the Platform, including profile images, dispute evidence, and identity verification documents submitted by House Sitters, may be stored using secure cloud storage services.</p>
            ...
            <SubSection number="10.4" title="Analytics and Performance Monitoring">
              <p>The House Sitter Directory may use analytics and performance monitoring tools to understand how the Platform is used and to improve the Service.</p>
            ...
            <SubSection number="10.5" title="Email and Communication Services">
              <p>The House Sitter Directory may use third-party email delivery services to send operational communications to users.</p>
              ...
              <p>Such services process email addresses and related communication data solely for the purpose of delivering these messages on behalf of The House Sitter Directory.</p>
            </SubSection>

            <SubSection number="10.6" title="Customer Support Tools">
              <p>The House Sitter Directory may use third-party customer support tools to manage user inquiries, support requests, and dispute communications.</p>
          ...
          <Section number="11" title="International Data Transfers">
            <p>The House Sitter Directory operates primarily within the European Economic Area (EEA). However, in order to provide the Platform and related services, The House Sitter Directory may use third-party service providers that process data in jurisdictions outside the EEA.</p>
            ...
            <p>The House Sitter Directory takes reasonable measures to ensure that personal data transferred internationally remains protected in accordance with applicable data protection standards.</p>
          </Section>

          {/* ─── Section 12 ─── */}
          <Section number="12" title="Changes to this Privacy Policy">
            <p>The House Sitter Directory may update or modify this Privacy Policy from time to time in order to reflect changes in the Platform, applicable laws, regulatory requirements, or data processing practices.</p>
            ...
            <p>Where material changes are made to this Privacy Policy, The House Sitter Directory may provide additional notice to users through appropriate means, which may include email notifications or notices displayed within the Platform.</p>
          ...
          <Section number="13" title="Contact Information">
            <p>If you have questions about this Privacy Policy or wish to exercise your data protection rights, you may contact The House Sitter Directory using the following contact details.</p>
            <div className="bg-gray-50 rounded-xl p-6 mt-4">
              ...
              <p className="mt-2">The House Sitter Directory will respond to privacy-related enquiries and requests in accordance with applicable data protection laws.</p>
            </div>
          </Section>
